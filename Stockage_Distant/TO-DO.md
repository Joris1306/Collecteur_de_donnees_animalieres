...
- [x] pile de données ambigües (pile étant la table principale, ambigüe noté d'un champ 'flag')
- [ ] table des détections (une image est associé, à une ou plusieurs détection)
...
- [x] bouton export sous forme tabulaire (excel)
- [x] ajouter une interface de login avant de visionner les données
- [x] bouton de suppression d'image (lié à sql_db)
