...
\begin{itemize}
    \item \textbf{Hardware} : Nolan Buchet sera en charge de l’architecture matérielle globale et de la gestion énergétique du système. 
    \item \textbf{Modules additionnels} : Jules Noumba s’occupera de l’intégration des différents modules et capteurs qui viendront se rajouter sur le piège caméra afin de récupérer les \gloss{metadonnees} liées aux photos.
