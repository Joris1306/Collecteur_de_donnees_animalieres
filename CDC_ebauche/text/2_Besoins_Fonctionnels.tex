...
\small
   ...
   \begin{itemize}
      ...
      \item \textbf{Acquisitions de données environnementales supplémentaires} : Ajout d'autres mesures via divers moyens (pression atmosphérique, CO$_2$, qualité de l'air, humidité, son, etc.).
   \end{itemize}