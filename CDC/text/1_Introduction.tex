...
Le système envisagé aura pour objectif de capturer des photographies d'espèces animales présentes sur la commune.
Ces images seront ensuite transmises à une base de données centralisée afin d'être analysées et répertoriées par les services municipaux et les partenaires scientifiques.
\newline
