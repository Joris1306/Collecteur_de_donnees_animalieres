...
% Nouvelle colonne type "P" qui justifie automatiquement et revient à la ligne
...
%\begin{landscape}
\vspace{0.5cm} % moins d'espace vertical avant le tableau

\begin{table}
    %\begin{adjustwidth}{-2.5cm}{1cm}
    %\end{adjustwidth}
    \centering
    % Encapsuler le tableau tourné et la légende dans une vbox
    \vbox{%
        \hspace*{-34pt} % décale le tableau vers la gauche
        % Tableau tourné et mis à l'échelle (seulement en X)
        \scalebox{0.9}[1]{%
            \rotatebox{90}{%
                \begin{tabular}{|P{2.5cm}|P{2.7cm}|P{2cm}|P{2cm}|P{2cm}|P{2.8cm}|P{2.4cm}|P{2cm}|P{1.5cm}|P{1.5cm}|}
                    \hline
                    \textbf{Mode}                    & \textbf{Principe}                            & \textbf{Portée typique}               & \textbf{Débit indicatif}          & \textbf{Avantages}                     & \textbf{Inconvénients}                        & \textbf{Coût / régulation}    & \textbf{Cas d’usage}                    & \textbf{Énergie} & \textbf{Prix} \\
                    \hline
                    ...
                    4G (LTE)                         & Réseau cellulaire                            & Couverture nationale/internationale   & 1–100+ Mb/s                       & Haut débit, mobilité, bonne latence    & Payant (SIM), énergivore                      & Abonnement, licences          & Vidéo, cloud, gros volumes              & 2 W              & 70 €          \\
                    \hline
                    Réseau cartes (filaire/sans fil) & SPI/I²C/ RS485/BLE/ Zigbee                   & $\sim$5–10 m (selon solution)         & Centaines kb/s à plusieurs Mb/s   & Simple, faible latence, économique     & Portée limitée, dépend du protocole           & Faible coût                   & Robotique, modules locaux               & 0,1 W            & Dépend du µC  \\
                    \hline
                    Wi-Fi HaLow (802.11ah)           & Wi-Fi sub-GHz pour IoT                       & Jusqu’à plusieurs centaines de mètres & kb/s à centaines kb/s             & Longue portée Wi-Fi, bonne pénétration & Peu répandu, matériel spécifique              & Puces dédiées, ISM            & IoT longue portée, réseaux capteurs     & 0,7 W            & 30 €          \\
                    \hline
                    ESP-NOW                          & Proto. Espressif communication directe Wi-Fi & 50–100 m (urbain), 200–250 m (champ)  & $\sim$1–2 Mb/s (pratique <1 Mb/s) & Faible latence, pas de routeur, facile & Limité aux ESP, pas de routage, portée < LoRa & Très faible coût (ESP32 < 5€) & Communi- cation ESP (robots, IoT local) & 1,5 W            & 10 €          \\
                    \hline
                \end{tabular}
            }% fin rotatebox
        }% fin scalebox
        \caption{Comparaison des différentes technologies de transmission possibles}
        \addcontentsline{lof}{figure}{\thetable\quad \hspace{2pt}Comparaison des différentes technologies de transmission possibles}
    }% fin vbox
    %\end{adjustwidth}
    % légende horizontale et centrée
\end{table}
...
\begin{table}
    ...
    \vbox{%
        ...
        \scalebox{0.9}[1]{%
            \rotatebox{90}{%
                \begin{tabular}{|P{2.2cm}|P{2.5cm}|P{2.2cm}|P{2cm}|P{2cm}|P{2.8cm}|P{2.4cm}|P{2cm}|P{1.5cm}|P{1.5cm}|}
                    \hline
        ...
        % petit espace entre le tableau et la légende
        \caption{Comparaison des modules caméras}
        \addcontentsline{lof}{figure}{\thetable\quad \hspace{2pt}Comparaison des modules caméras}
    }% fin vbox
    %\end{adjustwidth}
    % légende horizontale et centrée
\end{table}
...
\begin{table}[!ht]
    ...
    \vbox{%
        ...
        \addcontentsline{lof}{figure}{\thetable\quad \hspace{2pt}Comparaison des microcontrôleurs}
    }
\end{table}
...
\begin{table}[!ht]
    ...
    \vbox{%
        ...
        \addcontentsline{lof}{figure}{\thetable\quad \hspace{2pt}Comparaison des microcontrôleurs (suite)}
    }
\end{table}
