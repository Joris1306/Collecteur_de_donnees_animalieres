...
\begin{itemize}
   ...
   \item \textbf{Stockage distant} : les données reçues par le piège caméra sont stockées dans un stockage distant pour être exploités par les experts animaliers
\end{itemize}
