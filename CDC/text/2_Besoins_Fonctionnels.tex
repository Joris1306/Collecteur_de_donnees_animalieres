...
\begin{figure}[H]
   ...
   \caption{Décomposition en blocs fonctionnel principale et optionnelle}
...
\begin{figure}[h]
   \centering
   {
      \includegraphics[width=0.9\textwidth]{images/diagramme_wp+fp.pdf}
   }
   \caption{Diagramme des work package associé aux fonctionnalités principale et optionnel}
   \label{fig:DecFoncPrin}
\end{figure}
