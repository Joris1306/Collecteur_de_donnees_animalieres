...
\vspace{2em}
Le diagramme de Gantt ci-dessous permet de visualiser l'ensemble des tâches de chaques work packages du projets. Une couleur représente un work package. \\
\textbf{\textcolor{red}{--A mettre tous les wp--}}
\begin{figure}[h]
   \centering
   {
      \includegraphics[width=1\textwidth]{images/Gantt_taches_wp.png}
   }
   \caption{Diagramme de Gantt des livrables produits pour le client}
   \label{fig:LivClient}
\end{figure}