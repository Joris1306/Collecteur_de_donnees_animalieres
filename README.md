...
This project was developed in close partnership with the **Municipality of Saint-Mars-du-Désert** and its environmental partners: **WWF**, **LPO** (League for the Protection of Birds), and **Natura 2000**, who generously funded and supported our work.

---

## 🌍 Context & Vision

Biodiversity and species conservation have never been more critical. To protect our local wildlife effectively, we must first monitor and understand it. 

Our project tackles this challenge from the ground up by building an autonomous **Camera Trap paired with an AI-driven animal classification model**. Captured footage is securely transmitted to a central server and made accessible through an intuitive web interface. 

**The ultimate goal:** Automate the inventory and monitoring of local fauna to support the **ABC (Atlas de la Biodiversité Communale)** initiatives.
...
* Our supervising professors at **Polytech Nantes** for their invaluable academic guidance.
* The **Municipality of Saint-Mars-du-Désert** and its partner associations for their trust and financial backing.
* The biodiversity and research professionals who generously shared their expertise with us. Your willingness to help proves that wildlife conservation is a truly collaborative family.

We now pass the torch to future generations of passionate students. This project is entirely **open-source**, and we look forward to seeing how you adapt, improve, and scale it!
